...
{
	//读入场景图片
//	img=imread("G:\\Code-Foreground\\Data\\GrabCut\\origin\\HoloLens2.jpg",1);
	img=imread("G:\\Code-Foreground\\Data\\GrabCut\\origin\\20170228111043_scene.jpg",1);
	...
	for(;;){
		...
		if((char)c == 'p'){
			...
			*/
			...
			//保存前景图
			//imwrite("G:\\Code-Foreground\\Data\\GrabCut\\foreground\\HoloLens2.jpg",foregound);
			imwrite("G:\\Code-Foreground\\Data\\GrabCut\\foreground\\20170228111043_fore.jpg",foregound);
		}
		if(char(c)=='q')
			return 0;
	}
