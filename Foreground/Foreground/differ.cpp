...
int differ()
{
	...
	//载入背景图像
//	background=cvLoadImage("G:\\Code-Foreground\\Data\\Differ\\example_background.jpg");
	background=cvLoadImage("G:\\Code-Foreground\\Data\\Background\\20170228111043_back.jpg");
	cvNamedWindow("背景图像",0);
	cvResizeWindow("背景图像", 1216, 684);  //对窗口进行大小重新定义
	cvShowImage("背景图像",background);

	//载入场景图像
//	scene=cvLoadImage("G:\\Code-Foreground\\Data\\Differ\\example_scene.jpg");
	scene=cvLoadImage("G:\\Code-Foreground\\Data\\Scene\\20170228111043_scene.jpg");
...
//	cvSaveImage("G:\\Code-Foreground\\Data\\Differ\\Foreground\\example_foreground.jpg", foregoundImg);  //保存前景图片
	cvSaveImage("G:\\Code-Foreground\\Data\\Differ\\Foreground\\20170228111043_fore.jpg", foregoundImg);  //保存前景图片
